...
Note for Professor: I simply copied my program 1 and modified it.
...
print("- Small Coffee (S | 9 oz)")
print("- Medium Coffee (M | 12 oz)")
print("- Large Coffee (L | 15 oz)")
print("----------------------")
...
if coffeeChoice == "S" or coffeeChoice == "s" or coffeeChoice == "small" or coffeeChoice == "Small":
    ...
    if userMoney >= (coffeePrice * 1):
        print(" ")
        print("----------------------")
        print("You paid: ${:.2f}".format(userMoney))
        print(" ")
        print("Your change is: ${:.2f}".format(userMoney - (coffeePrice * 1)))
        print(" ")
...
if coffeeChoice == "M" or coffeeChoice == "m" or coffeeChoice == "medium" or coffeeChoice == "Medium":
    ...
    # If they entered more or equal to than the price, then it will complete the transaction
    # and show them their change.
    if userMoney >= (coffeePrice * 2):
        print(" ")
        print("----------------------")
        print("You paid: ${:.2f}".format(userMoney))
        print(" ")
        print("Your change is: ${:.2f}".format(userMoney-(coffeePrice * 2)))
        print(" ")
...
if coffeeChoice == "L" or coffeeChoice == "l" or coffeeChoice == "large" or coffeeChoice == "Large":
    ...
    # If they entered more or equal to than the price, then it will complete the transaction
    # and show them their change.
    if userMoney >= (coffeePrice * 3):
        print(" ")
        print("----------------------")
        print("You paid: ${:.2f}".format(userMoney))
        print(" ")
        print("Your change is: $", (userMoney - (coffeePrice * 3)))
        print(" ")
